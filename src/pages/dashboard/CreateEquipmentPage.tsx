...
import { getClients, getBranches, createEquipment } from '../../services/supabaseService';
...
const CreateEquipmentPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [clientsData, branchesData] = await Promise.all([getClients(), getBranches()]);
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-slate-500 text-sm">Register a new piece of equipment in the system.</p>
          </div>
        </div>
