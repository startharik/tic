...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const hasPermission = (permission: string): boolean => {
    ...
    const rolePermissions: Record<string, string[]> = {
      super_admin: ['*'],
      admin: ['*'],
      coordinator: ['read:jobs', 'write:jobs', 'read:equipment', 'read:documents', 'read:media', 'write:clients', 'write:branches', 'read:clients', 'read:inspections', 'write:inspections'],
